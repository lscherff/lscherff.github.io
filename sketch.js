...
function insideTheFence(position){
	...
	document.getElementById("content").innerHTML = '37.803456 N, 122.417144 W. Negash Asegde: <a href="http://www.acheron.co/" target="_blank">Acheron</a>, Clare Bland: <a href="" target="_blank">Title</a>, Emma Carroll: <a href="https://www.facebook.com/media/set/?set=a.10209412057402296.1073741836.1350529750&type=1&l=233e4f4f7f" target="_blank">INT(ERNET)IMACY</a>, John Erbach: <a href="Final Icarus LLC.pdf" target="_blank">Icarus LLC</a>, Yelin Huang: <a href="" target="_blank">Title</a>, Josie Kidde: <a href="" target="_blank">Title</a>, Danny Murzhanov: <a href="" target="_blank">Title</a>, Nate Woodward: <a href="" target="_blank">Title</a>.';
}
